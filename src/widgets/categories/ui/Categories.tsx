          ...
          {CATEGORIES.map((cat) => {
            ...
            return (
              <Link
                key={cat.key}
                href="/tours"
                className="group flex flex-col items-center gap-4 rounded-2xl bg-white p-6 shadow-sm transition-all hover:shadow-md hover:-translate-y-1"
              >
                <div
                  className={`flex h-16 w-16 items-center justify-center rounded-2xl ${cat.color} transition-transform group-hover:scale-110`}
                >
