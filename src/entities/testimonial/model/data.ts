...
export const TESTIMONIALS: Testimonial[] = [
  ...
  },
  {
    ...
    name: "Dmitriy N.",
    rating: 5,
    tour: "Egypt — Sharm El-Sheikh",
    text: {
      uz: "Misrga dam olishga bordik va hamma narsa ajoyib edi. Viza masalalarida ham yordam berishdi, sug'urta ham kiritilgan edi. Qaytib kelganimizda yana bir tur rejalashtirmoqchimiz. Eng yaxshi narxlar!",
      ru: "Ездили отдыхать в Египет — всё было замечательно. Помогли с визовыми вопросами, страховка была включена. По возвращении планируем ещё один тур. Лучшие цены!",
      en: "We went on vacation to Egypt — everything was wonderful. They helped with visa issues, insurance was included. Upon return, we're planning another tour. Best prices!",
    },
  },
  {
    id: "4",
